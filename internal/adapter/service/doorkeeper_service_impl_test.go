...
func (suite *DoorkeeperServiceImplTestSuite) TestVerifyParseAccessToken() {
	...
	suite.Run("Unsuccessful Verify and Parse", func() {
		...
		suite.Run("Expired Access Token", func() {
			...
			userToken := "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJlYXQiOjE3MDIyNjU2OTAsImlhdCI6MTcwMjI2NTY4OSwiaXNzIjoiVEVTVEFQUCIsIm5iZiI6MTcwMjI2NTY4OSwic3ViIjoiODQ3Y2U2MjYtNzVjMS00YjEyLTg4YzUtMDNiZTI0NWIyNWVjIn0.vrK338b8yFbkQN1oZFssxVqBXJv9t28_axtpJD5odmzIetu0CWXCb0GIszmFcc3Nn9EKR9_mNTFElciMnyUFjTpK4XevhTNQR7Igaw6_Ol2RB8baS1Czg8Q0cRNqJlDwmV0meNuzysJ81eRfzxPp8m7oDOvB1tD-toto9OHEDO8bO5u-Tw97bcfx_xFd2SRB0SoYZliv0p63jA8uDXa4w9Kvr2YNMJ1A8R_EJ3aiC-yrCbVQ6EjbVkH6qwHza5ucqYB9pQWAukFQiRy7SDXVSOSSLe9SGPJRUIRCcUEXTYYktZycYOnX91U67U5N4JV8twR7mHyecmHyRwGgvvlFzg"
